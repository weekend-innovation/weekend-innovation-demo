...
CHALLENGE_TITLE = "【テスト】横浜市に存在する製造業として、地方創生のための新商品又は新サービスを考えてください"
            ...
            for idx, prop in enumerate(proposals):
                ...
                for k in range(n_comments):
                    ...
                    comm = ProposalComment.objects.create(
                        ...
                        conclusion="参考になりました",
                        reasoning=f"横浜の製造業と地方創生について、貴重な視点だと思います。地域連携の具体案として興味深いです。",
                        is_deleted=False,
                    )
