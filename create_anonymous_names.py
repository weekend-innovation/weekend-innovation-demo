...
def create_anonymous_names():
    ...
    print(f"Created {created_count} new anonymous names")
    print(f"Total anonymous names in database: {AnonymousName.objects.count()}")
    ...
    print(f"Inorganic: {inorganic_count}")

if __name__ == '__main__':
    create_anonymous_names()
